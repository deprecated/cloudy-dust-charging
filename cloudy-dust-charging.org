...
** Utility for reading model
#+BEGIN_SRC python :tangle cloudy_tables.py
  ...
  class CloudyModel(object):
      ...
      >>> from cloudy_tables import CloudyModel
      >>> m = CloudyModel("mymodel", dir="myfolder")
...
#+BEGIN_SRC python :return pltfile :results file :exports both
  ...
  m = CloudyModel(PREFIX, dir="models")
