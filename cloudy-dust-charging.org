...
+ Adapt the stellar models [[id:E7E0D121-820E-470E-B39A-BDC77800E7FC][above]] but using the ISRF
  + One option would be to use ~table ism extinguish~
  + But I decided it would be better to use the exact SED from MMP83
  + This is written to the file [[file:models-isrf/isrf_mmp1983.sed]]
    + See [[id:C329DE08-2018-4D65-A81F-C15010403251][Compare SED between OB stars and interstellar field]]
...
+ This means that radiation field is 1470 / R^2 with R in pc
  + So to cover U = 0.1 \to 1e6, we use R = 0.0383 \to 120 pc
...
+ The emissivity from this model is compared with DL07 below in [[id:884CFA15-01DA-415E-9321-CE3447A3F81C][Cloudy emissivity exposed to MMP83 ISRF SED]]
...
:PROPERTIES:
:ID:       884CFA15-01DA-415E-9321-CE3447A3F81C
:END:
...
:PROPERTIES:
:ID:       C329DE08-2018-4D65-A81F-C15010403251
:END:
...
:PROPERTIES:
:ID:       BFADB49A-57C0-4D0F-B78A-3017B7CAAA55
:END:
