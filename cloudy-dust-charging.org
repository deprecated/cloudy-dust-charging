...
#+BEGIN_SRC python :return pltfile :results file
  ...
  ax.plot(DL07tab['U']/8.0, DL07tab['70'], 'o', alpha=0.1, color='k')
  ax.set(
      yscale='log',
      xscale='log',
      xlabel=r'Radiation field: $U = L_*\, /\, (4 \pi \,R^{2} \, F_{\mathrm{MMP83}})$',
...
#+BEGIN_SRC python :return pltfile :results file
  ...
  axes[0].plot(DL07tab['U'], DL07tab['24']/ DL07tab['8'], 'o', alpha=0.5)
  axes[1].plot(DL07tab['U'], DL07tab['70']/ DL07tab['24'], 'o', alpha=0.5)
  axes[2].plot(DL07tab['U'], DL07tab['170']/ DL07tab['70'], 'o', alpha=0.5)
...
#+BEGIN_SRC python :return pltfile :results file
  ...
  ax.plot(wav, 100*mmp1983sed(wav), label=r"IS radiation $\times 100$")
